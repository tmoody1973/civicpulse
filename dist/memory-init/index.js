...
{representativeConnection}`,
   ...
   */
  engagementNudge: {
    newUser: `\u{1F389} Welcome to CivicPulse! Here are some ways to get started:
...
- {repUpdates}
- {newsUpdates}`,
    highlyEngaged: `You're staying informed! \u{1F4CA} Your civic engagement score: {engagementScore}/100
- Bills tracked: {trackedBills}
- Podcasts listened: {podcastsListened}
- Days active this month: {activeDays}`
  }
};
var PODCAST_SCRIPT_TEMPLATES = {
  /**
...
Don't worry - we'll retry automatically. In the meantime, here's what we know from our cache.`,
  firstTimeUser: `Welcome to CivicPulse! \u{1F44B}
...
async function initializeProceduralMemory(memory, userId, force = false) {
  try {
...
// <stdin>
var stdin_default = MemoryInitService;
export {
  cors,
